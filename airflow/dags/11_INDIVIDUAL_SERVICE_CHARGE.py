...
TEMP_DATA_PATH = "/tmp/INDIVIDUAL_SERVICE_CHARGE.csv"
...
def extract(**context):
    ...
    SERVICE_NAME = "IndividualServiceChargeService"
...
def load(**context):
    ...
    df.to_sql(
        name="INDIVIDUAL_SERVICE_CHARGE",
        con=engine,
        if_exists="append",
        index=False,
        method="multi",
...
# -----------------------------
with DAG(
    dag_id="INDIVIDUAL_SERVICE_CHARGE",
