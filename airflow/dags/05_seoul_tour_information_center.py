...
TEMP_DATA_PATH = "/tmp/seoul_tour_information_center.csv"
...
def extract(**context):
    ...
    SERVICE_NAME = "TbTourInformation"
...
def load(**context):
    ...
    df.to_sql(
        name="SEOUL_TOUR_INFORMATION_CENTER",
        con=engine,
        if_exists="append",
        index=False,
        method="multi",
...
# -----------------------------
with DAG(
    dag_id="SEOUL_TOUR_INFORMATION_CENTER",
