...
TEMP_DATA_PATH = "/tmp/PRICE_MODEL_STORE_PRODUCT.csv"
...
def extract(**context):
    ...
    SERVICE_NAME = "ListPriceModelStoreProductService"
...
def load(**context):
    ...
    df.to_sql(
        name="PRICE_MODEL_STORE_PRODUCT",
        con=engine,
        if_exists="append",
        index=False,
        method="multi",
...
# -----------------------------
with DAG(
    dag_id="PRICE_MODEL_STORE_PRODUCT",
