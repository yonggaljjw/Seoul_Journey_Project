...
TEMP_DATA_PATH = "/tmp/seoul_tour_culture.csv"
...
def extract(**context):
    ...
    SERVICE_NAME = "TbVwEntertainment"
    BASE_URL = "http://openapi.seoul.go.kr:8088"

    # 1. 첫 요청
    first_body = fetch_page(BASE_URL, API_KEY, SERVICE_NAME, 1, 1000, 'ko')
